...
/**
 * Loads and indexes OpenAPI specs + entity schemas for service dispatch.
 */
public class OpsonApiSpecRegistry {

  private static final Logger log = LoggerFactory.getLogger(OpsonApiSpecRegistry.class);
  ...
  private final List<OpsonApiOperationDescriptor> operations = new ArrayList<>();
  ...
  public OpsonApiSpecRegistry(
      OpsonApiProperties properties, ResourceLoader resourceLoader) {
  ...
  private void loadEntitySchemas() {
    Map<String, SchemaMetadata> loaded =
        OpsonApiEntitySchemaLoader.loadEntitySchemas(resourceLoader, properties.getEntitySchemasLocation());
    loaded.forEach(
        (key, meta) -> {
  ...
  public String resolveService(OpsonApiOperationDescriptor operation) {
  ...
  public SchemaMetadata getEntitySchema(String entitySchemaPath) {
    ...
    SchemaMetadata meta = entitySchemasByPath.get(OpsonApiEntitySchemaLoader.normalizeSchemaPath(entitySchemaPath));
    if (meta != null) {
      return meta;
    }
  ...
  public OperationConstraints getOperationConstraints(OpsonApiOperationDescriptor operation) {
    if (operation.entitySchema() == null || operation.operationKey() == null) {
      return null;
    }
  ...
  public OpsonApiOperationDescriptor matchOperation(String method, String requestPath) {
    for (OpsonApiOperationDescriptor op : operations) {
  ...
  public Schema getRequestBodySchema(OpsonApiOperationDescriptor op) {
  ...
  public Map<String, Object> getOperationExtensions(OpsonApiOperationDescriptor descriptor) {
  ...
  public String resolveAtomicOperationService(OpsonApiOperationDescriptor operation, String operationId) {
