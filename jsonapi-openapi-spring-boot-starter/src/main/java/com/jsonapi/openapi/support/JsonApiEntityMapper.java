...
public class JsonApiEntityMapper {

  private static final Logger log = LoggerFactory.getLogger(JsonApiEntityMapper.class);
  private final OpenApiSpecRegistry registry;
  private final ObjectMapper objectMapper;

  public JsonApiEntityMapper(OpenApiSpecRegistry registry, ObjectMapper objectMapper) {
  ...
  private SchemaMetadata resolveMetadata(OperationDescriptor operation, String resourceType) {
  ...
  public Object createProbeEntity(
      OperationDescriptor operation, String entityPackage, ServiceContext context)
      throws Exception {
    String resourceType = operation.resourceType();
  ...
  public Object mapDataArray(JsonNode dataArray, String resourceType, String entityPackage)
    ...
    return mapRequestBody(
        ...
        new OperationDescriptor("atomic", "POST", "/", null, List.of(), true, resourceType),
        entityPackage,
        null);
  }

  private void mapDomainAttributes(
      JsonNode attributes, Object entity, SchemaMetadata meta, OperationDescriptor operation)
      throws Exception {
