...
final class OpsonApiWireSchemaJsonPatcher {
  ...
  private OpsonApiWireSchemaJsonPatcher() {}
                ...
                pathEntry
                    ...
                    .forEach(
                        opEntry -> {
                          ...
                          visitor.accept(
                              operation,
                              OpsonApiEntitySchemaSupport.normalizeSchemaPath(entitySchemaNode.asText()),
                              requestOp);
                        }));
  }
  ...
  private static void patchSuccessResponses(
      JsonNode operation, String entitySchema, String requestOp, Map<String, String> wireRefs) {
    String responseOp = OpsonApiWireSchemaGenerator.toResponseOperationKey(requestOp);
    if (responseOp == null) {
      return;
    }
        ...
        operation -> {
          ...
          for (String code : ERROR_RESPONSE_CODES) {
            ...
            inlineResponseSchema(
                (ObjectNode) response, OpsonApiWireSchemaGenerator.ERROR_WIRE_REF, errorDescription(code));
          }
        });
  }
  ...
  private static String wireRef(Map<String, String> wireRefs, String entitySchema, String operationKey) {
    ...
    if (ref == null) {
      ref = OpsonApiWireSchemaGenerator.wireRef(entitySchema, operationKey);
    }
    return ref;
  }
