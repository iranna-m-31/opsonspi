...
final class OpsonApiWireSchemaPatcher {

  private OpsonApiWireSchemaPatcher() {}
  ...
  private static void patchOperation(Operation operation, Map<String, String> wireRefs) {
    ...
    String entitySchema = OpsonApiEntitySchemaSupport.normalizeSchemaPath(entitySchemaObj.toString());
    String wireRef = wireRefs.get(entitySchema + "::" + operationKey);
    if (wireRef == null) {
      wireRef = OpsonApiWireSchemaGenerator.wireRef(entitySchema, operationKey);
    }
